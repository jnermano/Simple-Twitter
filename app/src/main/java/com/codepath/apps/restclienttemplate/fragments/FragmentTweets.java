...
public class FragmentTweets  extends Fragment {
    ...
    public static FragmentTweets newInstance(String screen_name) {
        FragmentTweets fragmentTweets = new FragmentTweets();
        Bundle bundle = new Bundle();
        bundle.putString("SCREEN_NAME", screen_name);
        fragmentTweets.setArguments(bundle);
    ...
    private void loadTweets(final int page) {
        ...
        if (!isOnline()) {
            ...
            client.getUserTimeline(page, screen_name, new JsonHttpResponseHandler() {
