...
**Simple Twitter** is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://developer.twitter.com/en/docs/api-reference-index).
...
<img src='https://github.com/jnermano/Simple-Twitter/raw/master/SimpleTwitter.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
