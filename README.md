...
**Simple Twitter** is an android app that allows a user to view home and mentions timelines, view user profiles with user timelines, as well as compose and post a new tweet. The app utilizes [Twitter REST API](https://developer.twitter.com/en/docs/api-reference-index).
...
<img src='https://github.com/jnermano/Simple-Twitter/raw/master/SimpleTwitterWeek4.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
